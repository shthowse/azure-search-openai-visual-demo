...
"--formrecognizerservice $env:AZURE_FORMRECOGNIZER_SERVICE --subscriptionId $env:AZURE_SUBSCRIPTION_ID --searchserviceassignedid $env:AZURE_SEARCH_SERVICE_ASSIGNED_USERID --tenantid $env:AZURE_TENANT_ID -v"
